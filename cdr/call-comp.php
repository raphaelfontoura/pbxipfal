	...
	<INPUT TYPE="hidden" NAME="posted" value=1>
		<table class="bar-status" width="75%" border="0" cellspacing="1" cellpadding="2" align="center">
			...
			<tr>
				...
				<td class="bar-search" align="center" bgcolor="#afc9b8"><input type="radio" NAME="dsttype" value="1" <?php if((!isset($dsttype))||($dsttype==1)){?>checked<?php }?>>Exato</td>
				<td class="bar-search" align="center" bgcolor="#afc9b8"><input type="radio" NAME="dsttype" value="2" <?php if($dsttype==2){?>checked<?php }?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" bgcolor="#afc9b8"><input type="radio" NAME="dsttype" value="3" <?php if($dsttype==3){?>checked<?php }?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" bgcolor="#afc9b8"><input type="radio" NAME="dsttype" value="4" <?php if($dsttype==4){?>checked<?php }?>>Termina com</td>
				</tr></table></td>
			</tr>			
			<tr>
				<td align="left" bgcolor="#f1f1f1">					
				...
				<td class="bar-search" align="left" bgcolor="#f1f1f1">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f1f1f1"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="src" value="<?php echo "$src";?>"></td>
				<td class="bar-search" align="center" bgcolor="#f1f1f1"><input type="radio" NAME="sourcetype" value="1" <?php if((!isset($sourcetype))||($sourcetype==1)){?>checked<?php }?>>Exato</td>
				<td class="bar-search" align="center" bgcolor="#f1f1f1"><input type="radio" NAME="sourcetype" value="2" <?php if($sourcetype==2){?>checked<?php }?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" bgcolor="#f1f1f1"><input type="radio" NAME="sourcetype" value="3" <?php if($sourcetype==3){?>checked<?php }?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" bgcolor="#f1f1f1"><input type="radio" NAME="sourcetype" value="4" <?php if($sourcetype==4){?>checked<?php }?>>Termina com</td>
				</tr></table></td>
			</tr>
			<tr>
				<td class="bar-search" align="left" bgcolor="#afc9b8">				
				...
				<td class="bar-search" align="center" bgcolor="#afc9b8"><input type="radio" NAME="clidtype" value="1" <?php if((!isset($clidtype))||($clidtype==1)){?>checked<?php }?>>Exato</td>
				<td class="bar-search" align="center" bgcolor="#afc9b8"><input type="radio" NAME="clidtype" value="2" <?php if($clidtype==2){?>checked<?php }?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" bgcolor="#afc9b8"><input type="radio" NAME="clidtype" value="3" <?php if($clidtype==3){?>checked<?php }?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" bgcolor="#afc9b8"><input type="radio" NAME="clidtype" value="4" <?php if($clidtype==4){?>checked<?php }?>>Termina com</td>
				</tr></table></td>
			</tr>
			<tr>
				<td align="left" bgcolor="#f1f1f1">					
				...
				<td class="bar-search" align="left" bgcolor="#f1f1f1">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f1f1f1"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="userfield" value="<?php echo "$userfield";?>"></td>
				<td class="bar-search" align="center" bgcolor="#f1f1f1"><input type="radio" NAME="userfieldtype" value="1" <?php if((!isset($userfieldtype))||($userfieldtype==1)){?>checked<?php }?>>Exato</td>
				<td class="bar-search" align="center" bgcolor="#f1f1f1"><input type="radio" NAME="userfieldtype" value="2" <?php if($userfieldtype==2){?>checked<?php }?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" bgcolor="#f1f1f1"><input type="radio" NAME="userfieldtype" value="3" <?php if($userfieldtype==3){?>checked<?php }?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" bgcolor="#f1f1f1"><input type="radio" NAME="userfieldtype" value="4" <?php if($userfieldtype==4){?>checked<?php }?>>Termina com</td>
				</tr></table></td>
			</tr>
			<tr>
				<td class="bar-search" align="left" bgcolor="#afc9b8">				
				...
				<td class="bar-search" align="center" bgcolor="#afc9b8"><input type="radio" NAME="accountcodetype" value="1" <?php if((!isset($accountcodetype))||($accountcodetype==1)){?>checked<?php }?>>Exato</td>
				<td class="bar-search" align="center" bgcolor="#afc9b8"><input type="radio" NAME="accountcodetype" value="2" <?php if($accountcodetype==2){?>checked<?php }?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" bgcolor="#afc9b8"><input type="radio" NAME="accountcodetype" value="3" <?php if($accountcodetype==3){?>checked<?php }?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" bgcolor="#afc9b8"><input type="radio" NAME="accountcodetype" value="4" <?php if($accountcodetype==4){?>checked<?php }?>>Termina com</td>
				</tr></table></td>
			</tr>			
			<tr>
			<td align="left" bgcolor="#f1f1f1">					
			...
			<tr>
				...
				<td class="bar-search" align="center" bgcolor="#afc9b8">
                                    
					<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#afc9b8"><tr><td>				
						
							<select name="min_call">					
							<option value=1 <?php if ($min_call==1){ echo "selected";}?>>Minutos por hora</option>
							<option value=0 <?php if (($min_call==0) || !isset($min_call)){ echo "selected";}?>>N&uacute;mero de chamadas por hora</option>
							</select>
						</td>
						<td align="right">							
