...
<!-- ** ** ** ** ** Part for the research ** ** ** ** ** -->
	<center>
	<FORM METHOD=POST ACTION="<?=$PHP_SELF?>?s=<?=$s?>&u=<?=$user?>&t=<?=$t?>&order=<?=$order?>&sens=<?=$sens?>&current_page=<?=$current_page?>">
	<INPUT TYPE="hidden" NAME="posted" value=1>
		<table class="bar-status" width="75%" border="0" cellspacing="1" cellpadding="2" align="center">
			...
			<tr bgcolor="#afc9b8">
				...
				<td class="bar-search" align="center" ><input type="radio" NAME="dsttype" value="1" <?php if((!isset($dsttype))||($dsttype==1)){?>checked<?php }?>>Exato</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="dsttype" value="2" <?php if($dsttype==2){?>checked<?php }?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="dsttype" value="3" <?php if($dsttype==3){?>checked<?php }?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="dsttype" value="4" <?php if($dsttype==4){?>checked<?php }?>>Termina com</td>
				</tr></table></td>
			</tr>			
			<tr bgcolor="#f1f1f1">
				<td align="left" >					
				...
				<td class="bar-search" align="left" >
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="src" value="<?php echo "$src";?>"></td>
				<td class="bar-search" align="center" ><input type="radio" NAME="sourcetype" value="1" <?php if((!isset($sourcetype))||($sourcetype==1)){?>checked<?php }?>>Exato</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="sourcetype" value="2" <?php if($sourcetype==2){?>checked<?php }?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="sourcetype" value="3" <?php if($sourcetype==3){?>checked<?php }?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="sourcetype" value="4" <?php if($sourcetype==4){?>checked<?php }?>>Termina com</td>
				</tr></table></td>
			</tr>
			<tr bgcolor="#afc9b8">
				<td class="bar-search" align="left" >				
				...
				<td class="bar-search" align="center" ><input type="radio" NAME="clidtype" value="1" <?php if((!isset($clidtype))||($clidtype==1)){?>checked<?php }?>>Exato</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="clidtype" value="2" <?php if($clidtype==2){?>checked<?php }?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="clidtype" value="3" <?php if($clidtype==3){?>checked<?php }?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="clidtype" value="4" <?php if($clidtype==4){?>checked<?php }?>>Termina com</td>
				</tr></table></td>
			</tr>
			<tr bgcolor="#f1f1f1">
				<td align="left" >					
				...
				<td class="bar-search" align="left" >
				<table width="100%" border="0" cellspacing="0" cellpadding="0" ><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="userfield" value="<?php echo "$userfield";?>"></td>
				<td class="bar-search" align="center" ><input type="radio" NAME="userfieldtype" value="1" <?php if((!isset($userfieldtype))||($userfieldtype==1)){?>checked<?php }?>>Exato</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="userfieldtype" value="2" <?php if($userfieldtype==2){?>checked<?php }?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="userfieldtype" value="3" <?php if($userfieldtype==3){?>checked<?php }?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="userfieldtype" value="4" <?php if($userfieldtype==4){?>checked<?php }?>>Termina com</td>
				</tr></table></td>
			</tr>
			<tr bgcolor="#afc9b8">
				<td class="bar-search" align="left" >				
				...
				<td class="bar-search" align="center" ><input type="radio" NAME="accountcodetype" value="1" <?php if((!isset($accountcodetype))||($accountcodetype==1)){?>checked<?php }?>>Exato</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="accountcodetype" value="2" <?php if($accountcodetype==2){?>checked<?php }?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="accountcodetype" value="3" <?php if($accountcodetype==3){?>checked<?php }?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="accountcodetype" value="4" <?php if($accountcodetype==4){?>checked<?php }?>>Termina com</td>
				</tr></table></td>
			</tr>			
			<tr bgcolor="#f1f1f1">
			<td align="left" >					
