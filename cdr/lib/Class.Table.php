...
class Table {
	...
	function Define_table ($table) {     
        ...
        //utilizado no call-log para trazer o custo da chamada da tabela pbxip_custo
	function Get_list_ ($clause=null, $join = null, $order=null, $sens=null, $field_order_letter=null, $letters = null, $limite=null, $current_record=NULL) {
		//global $link;
		global $DBHandle;


		$sql = 'SELECT '.$this -> fields.' FROM '.trim($this -> table).' '.$join;
